<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	if(!function_exists('toUrlSlug')){
		function toUrlSlug($input_str, $options = array()){
			
			$str = mb_convert_encoding((string)$input_str, 'UTF-8', mb_list_encodings());
			...
			// Tell PHP by which locale to replace characters
			...
			$str = preg_replace('/[^a-z0-9_ ]/i', $options['delimiter'], $str); 
